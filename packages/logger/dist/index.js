...
function hex(data) {
  if (supports_color_default.stderr.has16m) {
    return ansi_styles_default.hexToRgb(data);
  }
  if (supports_color_default.stdout.has256) {
    return ansi_styles_default.hexToAnsi256(data);
  }
  if (supports_color_default.stdout) {
    return ansi_styles_default.hexToAnsi(data);
  }
}
function rgb(data) {
  if (supports_color_default.stderr.has16m) {
  ...
  if (supports_color_default.stdout.has256) {
    return ansi_styles_default.rgbToAnsi256(...data);
  }
  if (supports_color_default.stdout) {
    return ansi_styles_default.rgbToAnsi(...data);
  }
}
...
function color(c, s) {
  ...
  if (supports_color_default.stderr.has16m) {
    return `${ansi_styles_default.color.ansi16m(...color2)}${s}${ansi_styles_default.color.close}`;
  }
  if (supports_color_default.stdout.has256) {
    return `${ansi_styles_default.color.ansi256(color2)}${s}${ansi_styles_default.color.close}`;
  }
  if (supports_color_default.stdout) {
    return `${ansi_styles_default.color.ansi(color2)}${s}${ansi_styles_default.color.close}`;
  }
}
function background(c, s) {
  const color2 = parseColor(c);
  if (supports_color_default.stderr.has16m) {
    return `${ansi_styles_default.bgColor.ansi16m(...color2)}${s}${ansi_styles_default.bgColor.close}`;
  }
  if (supports_color_default.stdout.has256) {
    return `${ansi_styles_default.bgColor.ansi256(color2)}${s}${ansi_styles_default.bgColor.close}`;
  }
  if (supports_color_default.stdout) {
    return `${ansi_styles_default.bgColor.ansi(color2)}${s}${ansi_styles_default.bgColor.close}`;
  }
}
var Logger = class {
  title;
